...
type AzureInitParameters struct {
	...
	// (String) Location mode. primary_only or secondary_only. See the Azure storage redundancy documentation for more details.
...
type SnapshotRepositoryInitParameters struct {
	...
	// (Block List, Max: 1) Support for using Azure Blob storage as a repository for Snapshot/Restore. See the repository Azure plugin documentation for more details. (see below for nested schema)
	...
	// (Block List, Max: 1) Support for using the Google Cloud Storage service as a repository for Snapshot/Restore. See the repository GCS plugin documentation for more details. (see below for nested schema)
	...
	// (Block List, Max: 1) Support for using HDFS File System as a repository for Snapshot/Restore. See the repository HDFS plugin documentation for more details. (see below for nested schema)
...
// SnapshotRepository is the Schema for the SnapshotRepositorys API. Registers or updates a snapshot repository. See the put snapshot repository API documentation https://www.elastic.co/guide/en/elasticsearch/reference/current/put-snapshot-repo-api.html and register repository documentation https://www.elastic.co/guide/en/elasticsearch/reference/current/snapshots-register-repository.html for more details.
