...
type RolloverInitParameters struct {
	...
	// (Number) Triggers rollover when the largest primary shard in the index reaches a certain number of documents. Supported from Elasticsearch version 8.2
	...
	MaxPrimaryShardDocs *float64 `json:"maxPrimaryShardDocs,omitempty" tf:"max_primary_shard_docs,omitempty"`
...
type ShrinkInitParameters struct {
	...
	// (Boolean) If true, the shrunken index is made writable by removing the write block.
	// If true, the shrunken index is made writable by removing the write block.
	AllowWriteAfterShrink *bool `json:"allowWriteAfterShrink,omitempty" tf:"allow_write_after_shrink,omitempty"`
...
// IndexLifecycle is the Schema for the IndexLifecycles API. Creates or updates lifecycle policy. See: https://www.elastic.co/guide/en/elasticsearch/reference/current/ilm-put-lifecycle.html and https://www.elastic.co/guide/en/elasticsearch/reference/current/ilm-index-lifecycle.html
